...
\section{Vyhodnocení projektu}
	...
	Při řešení reálného problému s reálnou firmou by bylo nejspíš taktíž jednodušší řešit SWOT analýzu, PESTEL i 5F. V tomto virtuálním případě je nutné vytvářet pozadí problému, firmy a okolí a následně z toho vycházet pro tyto analýzy. Proto výsledky někdy nejsou takové, jak by bylo předpokládáno a bylo vhodné.		
