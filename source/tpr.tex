	...
	\subsection{Obchodní přínos}
		\subsubsection{Náklady}
			...
			\begin{table}[htbp!]
				...
				rozpočet &\multicolumn{2}{c|}{}& 1588000\\ \noalign{\hrule height 2pt}
			...
			\end{table}
				...
				rozpočet &\multicolumn{2}{c|}{}& 175000\\ \noalign{\hrule height 2pt}
...
\noalign{\hrule height 2pt}
	...
	\cellcolor{lightgray} & osvětlení vyhovující všem normám a hygienickým předpisů je nainstalováno & počet připomínek k~osvětlení od revizního technika & zpráva revizního technika & porucha svítidel, vyšší moc\   \\ \hline
	\cellcolor{lightgray} & nevyhovující kabeláž a svítidla jsou odstraněny & počet odstraněných svítidel a metrů kabeláže & pracovní deník & ztráta deníku\   \\ \hline
	\cellcolor{lightgray} & jsou nainstalována vyhovující svítidla a kabeláž & počet namontovaných vyhovujících svítidel a kabeláže  & pracovní deník & \ ztráta deníku
   \\ \hline
	\cellcolor{lightgray} & zrakový komfort je zvýšen & hodnota osvětlenosti
  & zpráva revizního technika & špatný výpočet \\ \hline
	\cellcolor{lightgray} & příspěvek z~fondu je získán & peněžitá částka & výpis z~účtu klienta, zpráva příslušného ogránu & nevyhovující kritéria, nesprává přihláška, zamítnutí žádosti\\ \noalign{\hrule height 2pt}
	\multicolumn{5}{!{\vrule width 2pt}c!{\vrule width 2pt}}{\textbf{účel projektu}}   \\ \noalign{\hrule height 2pt}
	\cellcolor{lightgray} & výměna stávajícího osvětlení a kabeláže v~garážích oc za vyhovující a předání vyhovujícího díla zákazníkovi & všechny svítidla v~garážích a všechna kabelová instalace je vyměněna do 30.09.2021 a je funkční a předána zákazníkovi & předávací protokol & zpoždění harmonogramu, vyšší moc\\ \noalign{\hrule height 2pt}
	...
	2 & zastaralý materiál je ekologicky likvidován & likvidační protokol předán s~veškerou dokumentací. & originál protokolu přiložen ke kompletní dokumentaci, kopie přiložené do ostatních dokumentací a scan přiložen k~elektronické verzi dokumentace & odběrové místo nebude schopno odebrat materiál, bude nutnost odvést starý materiál na jiné, vzdálenější místo  \\ \hline
	3 & zastaralá svítidla jsou demontována a nových vyhovující jsou montována & žádné zastaralé svítidlo není namontováno & kontrola všech svítidel, zapsání čísla svítidla při montáži do seznamu svítidel & nebudou dodána požadovaná svítidla včas  \\ \hline
	4 &  dotace z~fondu pro revitalizace veřejně prospěšných objektů je schválena & potvrzení o~získání dotace přijato x & potvrzení o~příjmu dotace + peníze na účtě investora & zamítnutí dotace z~fondu, vyčerpání peněz z~fondu dřív, než o~ně bude zažádáno  \\ \hline
...
\section{Realizace}
	...
	\subsection{WBS}
			...
			\indent \indent \indent \indent 1.1.2.2.1 Ověření výpočtu simulací\\
			\indent \indent \indent \indent 1.1.2.2.2 Vložení výsledku a dokumentace o~výpočtu osvětlení do GTWD\\
			\indent \indent \indent 1.1.2.5 Návrh svítidel\\
				...
				\indent \indent \indent \indent 1.1.2.5.3 Vložení návrhu vybraných svítidel do GTWD\\
				\indent \indent \indent \indent \indent 1.1.2.5.3.1 Komunikace se zákazníkem ohledně vybraného designu svítidel v~GTWD\\
				\indent \indent \indent \indent \indent 1.1.2.5.3.2 Dodatečná kontrola/úprava vybraných svítidel\\
		...
		\indent \indent 1.1.3 Projekce elektroinstalace\\
			\indent \indent \indent 1.1.3.1 Výpočet zatížení a příkonu\\
				...
				\indent \indent \indent \indent 1.1.3.1.2 Vložení výsledků do GTWD\\
			...
			\indent \indent \indent 1.1.3.4 Vytvoření návrhu a projekce moderních rozvaděčů\\
				...
				\indent \indent \indent \indent \indent 1.1.3.4.2.1. Konzultace návrhu s~klientem\\
	...
	\indent 1.4 Legislativní úkony\\
		...
		\indent \indent 1.4.2 Žádost o~dotace\\
			...
			\indent \indent \indent \indent 1.4.2.2.1 Dodání plné žádosti\\
		...
		\indent \indent 1.4.4 Uvedení do provozu\\
			...
			\indent \indent \indent \indent 1.4.4.4.1 Schválení protokolu klientem\\
			\indent \indent \indent \indent 1.4.4.4.2 Tisk protokolu\\
			\indent \indent \indent 1.4.4.7 Podpis protokolu oběma smluvními stranami\\
			\indent \indent \indent \indent 1.4.3.7.1 Vložení oskenované kopie protokolu do GTWD\\
	...
	\indent 1.5 Kontrola průběhu projektu\\
		...
		\indent \indent \indent 1.5.7.1 Archivace projektu v~GTWD\\
		\indent \indent 1.5.9 Zaslání archivačního odkazu do GTWD zákazníkovi\\
		\indent \indent \indent 1.5.9.1 Vyřazení projektu z~aktivních projektů v~GTWD\\
...
\resizebox{1 \textwidth}{!}
	...
	\cellcolor{lightgray}	\textbf{Projekt:} Rekonstrukce osvětlení a kabeláže garáži OC Trnávka 2021 & \cellcolor{lightgray}\textbf{Zpracoval:} Jan Hnát a Petr Zakopal &\cellcolor{lightgray} \textbf{Vytvořeno: }20.03.2021 & \cellcolor{lightgray}\textbf{Verze} 0.1 & \cellcolor{lightgray}\textbf{Kontrola:} Firma HnaZak\\\noalign{\hrule height 2pt}
	...
	5 & dodávka svítidel & poškození svítidel & nedostatek svítidel & 5 & p & nesprávná manipulace & 5 & zakoupení více svítidel při prvotní objednávce & 1 & 75 & pevnější obaly svítidel & řídící pracovník & v~plánu  \  \\ \hline
