...
\section{Strategie - business}
	\subsection{Deklarace záměru}
		...
		Naší misí je relizace projektů v oborech elektro, automatizace, stavby a architektury, které budou úspěšné a dále bezproblémové. Naše firma zaměstnává absolventy rpůmyslových škol při jejich studiu i po něm. Snaha firmy je směřována na dodávání kvalitních služeb s pomocí kvalitních výrobků.
